...
namespace ZumNet.DAL.Base.Oracle
{
    ...
    public class ParamData : ISerializable
    {
        ...
        private OracleParameter[] _sqlParams = null;
        ...
        /// 파라미터
        /// </summary>
        public OracleParameter[] SqlParams { get => _sqlParams; set => _sqlParams = value; }
        ...
        public ParamData(string query, OracleParameter[] sqlParams)
        {
            this._queryString = query;
            this._commandType = "";
            this._srcTable = "ResultTable";
        ...
        /// <param name="sqlParams">SqlParameters</param>
        public ParamData(string query, string cmdType, OracleParameter[] sqlParams)
        {
            this._queryString = query;
        ...
        /// <param name="sqlParams">SqlParameters</param>
        public ParamData(string query, string cmdType, int cmdTimeout, OracleParameter[] sqlParams)
        {
            this._queryString = query;
            this._commandType = cmdType;
            this._srcTable = "ResultTable";
        ...
        /// <param name="cmdTimeout">실행제한시간</param>
        /// <param name="sqlParams">SqlParameters</param>
        public ParamData(string query, string cmdType, string srcTable, int cmdTimeout, OracleParameter[] sqlParams)
        {
            this._queryString = query;
            this._commandType = cmdType;
        ...
        protected ParamData(SerializationInfo si, StreamingContext context)
        {
            if (si.GetBoolean("Exist"))
            {
                ...
                this._sqlParams = new OracleParameter[this._dbTypeList.Length];
                for (int i = 0; i < this._dbTypeList.Length; i++)
                {
                    this._sqlParams[i] = new OracleParameter();
