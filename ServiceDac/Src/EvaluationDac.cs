...
namespace ZumNet.DAL.ServiceDac
{
	...
	public class EvaluationDac : DacBase
	{
		...
		/// 
		/// </summary>
		public EvaluationDac(SqlConnection connection) : base(connection)
		{
		...
		/// <returns></returns>
		public DataSet GetExpertList(int domainID, string aualias, string objectType)
		{
			...
			ParamData pData = new ParamData("admin.ph_up_ExpertGetAuthority", parameters);
