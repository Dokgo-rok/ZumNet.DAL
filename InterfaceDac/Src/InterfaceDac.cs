...
namespace ZumNet.DAL.InterfaceDac
{
	...
	public class InterfaceDac : DacBase
    {
                                    ...
                                    , string formDB, string formTable, string xfAlias, string formID, string msgID, string oID)
        {
            ...
            ParamData pData = new ParamData(strSP, "", 300, parameters);
...
";
        ...
        /// <param name="cardCorp"></param>
        /// <param name="memmberType"></param>
        /// <param name="cardPeriod"></param>
        /// <param name="limitAmount"></param>
        /// <param name="cardType"></param>
        /// <param name="cardUsage"></param>
        /// <param name="reqDate"></param>
        /// <param name="isuDate"></param>
        /// <param name="rtnDate"></param>
        /// <param name="cardState"></param>
        /// <param name="isuState"></param>
        /// <param name="useNm"></param>
        /// <param name="useId"></param>
        /// <param name="useEmpId"></param>
        /// <param name="useDept"></param>
        /// <param name="useDeptId"></param>
        /// <param name="posUr"></param>
        /// <param name="posUrId"></param>
        /// <param name="posDept"></param>
        /// <param name="posDeptId"></param>
        /// <param name="mgrNm"></param>
        /// <param name="mgrId"></param>
        /// <param name="mgrDept"></param>
        /// <param name="mgrDeptId"></param>
        /// <param name="memo"></param>
        /// <returns></returns>
        public int SetCARDINFO(int ccId, string cardNum, string cardCorp, string memmberType, string cardPeriod, string limitAmount, string cardType
                    , string cardUsage, string reqDate, string isuDate, string rtnDate, string cardState, string isuState
                    , string useNm, int useId, string useEmpId, string useDept, int useDeptId, string posUr, int posUrId, string posDept, int posDeptId
                    , string mgrNm, int mgrId, string mgrDept, int mgrDeptId, string memo)
        {
            int iReturn = 0;
            ...
            string strSP = strInterfacerDB + ".dbo.up_IF_setCARDINFO";

            SqlParameter[] parameters = new SqlParameter[]
            {
                ParamSet.Add4Sql("@ccid", SqlDbType.Int, 4, ccId),
                ParamSet.Add4Sql("@cardnum", SqlDbType.VarChar, 20, cardNum),
                ParamSet.Add4Sql("@cardcorp", SqlDbType.VarChar, 3, cardCorp),
                ParamSet.Add4Sql("@membertype", SqlDbType.NVarChar, 20, memmberType),
                ParamSet.Add4Sql("@cardprid", SqlDbType.VarChar, 10, cardPeriod),
                ParamSet.Add4Sql("@limitamt", SqlDbType.NVarChar, 20, limitAmount),
                ParamSet.Add4Sql("@cardtype", SqlDbType.NVarChar, 20, cardType),
                ParamSet.Add4Sql("@cardusage", SqlDbType.NVarChar, 50, cardUsage),
                ParamSet.Add4Sql("@reqdate", SqlDbType.VarChar, 30, reqDate),
                ...
                ParamSet.Add4Sql("@usedept", SqlDbType.NVarChar, 50, useDept),
                ParamSet.Add4Sql("@usedeptid", SqlDbType.Int, 4, useDeptId),
                ParamSet.Add4Sql("@posur", SqlDbType.NVarChar, 50, posUr),
                ParamSet.Add4Sql("@posurid", SqlDbType.Int, 4, posUrId),
                ParamSet.Add4Sql("@posdept", SqlDbType.NVarChar, 50, posDept),
                ParamSet.Add4Sql("@posdeptid", SqlDbType.Int, 4, posDeptId),
                ParamSet.Add4Sql("@mgrnm", SqlDbType.NVarChar, 50, mgrNm),
                ParamSet.Add4Sql("@mgrid", SqlDbType.Int, 4, mgrId),
                ParamSet.Add4Sql("@mgrdept", SqlDbType.NVarChar, 50, mgrDept),
                ParamSet.Add4Sql("@mgrdeptid", SqlDbType.Int, 4, mgrDeptId),
                ParamSet.Add4Sql("@memo", SqlDbType.NVarChar, 500, memo),

                ParamSet.Add4Sql("@outid", SqlDbType.Int, 4, ParameterDirection.Output)
            };
        ...
        /// <param name="mgrDeptId"></param>
        /// <param name="memo"></param>
        /// <param name="eaMsgId"></param>
        /// <param name="eaMsgLink"></param>
        public void SetCARDLINK(int ccId, string memmberType, string cardType, string cardUsage, string useNm, int useId, string useEmpId, string useDept, int useDeptId
                        , string posUr, int posUrId, string posDept, int posDeptId, string mgrNm, int mgrId, string mgrDept, int mgrDeptId, string memo, int eaMsgId, string eaMsgLink)
        {
            string strInterfacerDB = Framework.Configuration.ConfigINI.GetValue(Framework.Configuration.Sections.SECTION_DBNAME, Framework.Configuration.Property.INIKEY_DB_INTERFACE);
            string strSP = strInterfacerDB + ".dbo.up_IF_setCARDLINK";
            ...
            SqlParameter[] parameters = new SqlParameter[]
            {
                ...
                ParamSet.Add4Sql("@mgrdeptid", SqlDbType.Int, 4, mgrDeptId),
                ParamSet.Add4Sql("@memo", SqlDbType.NVarChar, 500, memo),
                ParamSet.Add4Sql("@ea_msgid", SqlDbType.Int, 4, eaMsgId),
                ParamSet.Add4Sql("@ea_msglink", SqlDbType.VarChar, 1, eaMsgLink),
            };
        ...
        /// <summary>
        /// 카드사용정보 메모기록 또는 지출결의서 사용 예외 체크
        /// </summary>
        /// <param name="ackId"></param>
        /// <param name="regNm"></param>
        /// <param name="regId"></param>
        /// <param name="regDept"></param>
        /// <param name="regDeptId"></param>
        /// <param name="exceptProc"></param>
        /// <param name="memo"></param>
        public void SetCARDACKMEMO(int ackId, string regNm, int regId, string regDept, int regDeptId, string exceptProc, string memo)
        {
            string strInterfacerDB = Framework.Configuration.ConfigINI.GetValue(Framework.Configuration.Sections.SECTION_DBNAME, Framework.Configuration.Property.INIKEY_DB_INTERFACE);
            string strSP = strInterfacerDB + ".dbo.up_IF_setCARDACKMEMO";

            SqlParameter[] parameters = new SqlParameter[]
            {
                ParamSet.Add4Sql("@ackid", SqlDbType.Int, 4, ackId),                
                ParamSet.Add4Sql("@regnm", SqlDbType.NVarChar, 500, regNm),
                ParamSet.Add4Sql("@regid", SqlDbType.Int, 4, regId),
                ParamSet.Add4Sql("@regdept", SqlDbType.NVarChar, 50, regDept),
                ParamSet.Add4Sql("@regdeptid", SqlDbType.Int, 4, regDeptId),
                ParamSet.Add4Sql("@exceptproc", SqlDbType.VarChar, 1, exceptProc),
                ParamSet.Add4Sql("@memo", SqlDbType.NVarChar, 500, memo)
            };
